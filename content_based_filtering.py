...
def train_transformer(data):
    ...
    transformer = ColumnTransformer(transformers=[
        ...
        ("tfidf", TfidfVectorizer(max_features=300), tfidf_col),
...
def main(data_path):
    ...
    data_content_filtering = data.copy()
    print("Training columns:", data_content_filtering.columns)
